...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Hmd290/sbb_s"
    )
    ...
    redthon_START = os.environ.get("redthon_START", None)
    PMPERMIT_TEXT_redthon = os.environ.get("PMPERMIT_TEXT_redthon", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in redthon
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-catredthon-01-01
