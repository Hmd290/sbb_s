...
class redthonUserBotClient(TelegramClient):
    def ar_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**⪼ تقرير خطأ ردثون 𓆰،**\n\n"
                        link = "[هنا](https://t.me/redthon_support)"
            ...
            if pattern is not None:
                ...
                if edited:
                    sbb_s.add_event_handler(func, events.MessageEdited(**kwargs))
                sbb_s.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                sbb_s.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                sbb_s.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
redthonUserBotClient.fast_download_file = download_file
redthonUserBotClient.fast_upload_file = upload_file
redthonUserBotClient.reload = restart_script
redthonUserBotClient.get_msg_link = get_message_link
redthonUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    redthonUserBotClient.send_message = send_message
    redthonUserBotClient.send_file = send_file
    redthonUserBotClient.edit_message = edit_message
