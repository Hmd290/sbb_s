...
@sbb_s.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular sbb_s",
    },
)
...
@sbb_s.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catsbb_s is One of the Popular sbb_s",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@sbb_s.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular sbb_s",
    },
)
async def nekobot(cat):
...
@sbb_s.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular sbb_s",
    },
)
async def nekobot(cat):
