# sbb_s module for purging unneeded messages(usually spam or ot).
import re
...
@sbb_s.ar_cmd(pattern="حذف رسائلي")
...
@sbb_s.ar_cmd(pattern="تنظيف(?:\s|$)([\s\S]*)")
