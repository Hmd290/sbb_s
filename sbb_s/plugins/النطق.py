...
@sbb_s.ar_cmd(pattern="انطق(?:\s|$)([\s\S]*)")
async def _(event):
    ...
    if ";" in input_str:
        ...
        text = input_str
        lan = "ar"
    sbb_sevent = await edit_or_reply(event, "⌔∮ جـار التسجيل انتـظر قليلا")
    ...
    try:
        ...
        await edit_or_reply(sbb_sevent, f"**خطأ:**\n`{e}`")
