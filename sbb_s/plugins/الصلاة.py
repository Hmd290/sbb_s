...
from . import edit_delete, edit_or_reply, sbb_s


@sbb_s.ar_cmd(pattern="صلاة(?:\s|$)([\s\S]*)")
async def get_adzan(adzan):
    ...
    if request.status_code != 200:
        await edit_delete(
            ...
            15,
        )  # ترجمه فريق ردثون على التيلكرام
        return
    result = json.loads(request.text)
    sbb_sresult = f"<b>اوقات صلاه المسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, sbb_sresult, "html")
