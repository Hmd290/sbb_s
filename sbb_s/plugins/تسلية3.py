...
from . import edit_delete, edit_or_reply, sbb_s, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m sbb_s`",
        "**State changed from starting to up**",
        "__INFO:sbb_s:Logged in as 557667062__",
        "__INFO:sbb_s:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@sbb_s.on(admin_cmd(pattern="احبك"))
async def rz(sbb_s):
    roz = random.choice(love)
    return await edit_or_reply(sbb_s, roz)
