...
from wand.image import Image as sbb_simage

from .utils import _sbb_sutils
...
async def sbb_s_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def sbb_s_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = sbb_simage(filename=picture_name)
    main_image.resize(
