...
PATH = "./sbb_s/cache/ytsearch.json"
...
async def yt_search(sbb_s):
    try:
        sbb_s = urllib.parse.quote(sbb_s)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={sbb_s}"
        )
...
"""
async def yt_data(sbb_s):
    params = {"format": "json", "url": sbb_s}
